        ...
        <div class="card shadow-sm border-0 mt-4">
            <div class="card-header bg-white border-bottom py-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="card-title mb-0 fw-bold text-dark">Cadastrar Novo Produto</h5>
                </div>
                <p class="text-muted small mb-0 mt-1">Preencha as especificações técnicas e a quantidade inicial do produto.</p>
            </div>
            <div class="card-body p-4">
                <form class="row g-3" wire:submit.prevent='store'>
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control form-control-lg bg-light @error('nome') is-invalid @enderror" id="nome" placeholder="Ex: Bloco de Concreto" wire:model='nome'>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control bg-light @error('textura') is-invalid @enderror" id="textura" placeholder="Ex: Rugoso / Lisa" wire:model='textura'>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control bg-light @error('faixa_etaria_minima') is-invalid @enderror" id="faixa_etaria_minima" placeholder="Ex: Livre, +12, +18" wire:model='faixa_etaria_minima'>
                        @error('faixa_etaria_minima') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>

                    <div class="col-12 d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                        <a href="{{ route('produto.index') }}" class="btn btn-light px-4">Cancelar</a>
                        <button type="submit" class="btn btn-primary px-4 fw-semibold">Salvar Produto</button>
                    </div>
                </form>
            </div>
        </div>
